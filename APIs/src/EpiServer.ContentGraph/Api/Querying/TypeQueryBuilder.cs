...
namespace EPiServer.ContentGraph.Api.Querying
{
    public partial class TypeQueryBuilder<T> : TypeQueryBuilder
    {
        ...
        /// <param name="fieldSelector">The object</param>
        /// <param name="propertySelector">Inner property of the object</param>
        /// <param name="limit">Number of facets to be returned</param>
        /// <returns></returns>
        public TypeQueryBuilder<T> Facet<TField>(Expression<Func<T, IEnumerable<TField>>> fieldSelector, Expression<Func<TField, string>> propertySelector, int? limit = null)
        {
            fieldSelector.ValidateNotNullArgument("fieldSelector");
            propertySelector.ValidateNotNullArgument("propertySelector");

            Facet($"{(limit.HasValue ? fieldSelector.GetFieldPath().FacetLimit(limit.Value) : fieldSelector.GetFieldPath())}.{propertySelector.GetFieldPath()}");
            return this;
        }
        ...
        /// <param name="limit">Number of facets to be returned</param>
        /// <returns></returns>
        public TypeQueryBuilder<T> Facet<TField>(Expression<Func<T, IEnumerable<TField>>> fieldSelector, Expression<Func<TField, bool>> propertySelector, int? limit = null)
        {
            fieldSelector.ValidateNotNullArgument("fieldSelector");
            propertySelector.ValidateNotNullArgument("propertySelector");
        ...
        /// <param name="limit">Number of facets to be returned</param>
        /// <returns></returns>
        public TypeQueryBuilder<T> Facet<TField>(Expression<Func<T, IEnumerable<TField>>> fieldSelector, Expression<Func<TField, int>> propertySelector, int? limit = null)
        {
            fieldSelector.ValidateNotNullArgument("fieldSelector");
            propertySelector.ValidateNotNullArgument("propertySelector");
        ...
        /// <param name="limit">Number of facets to be returned</param>
        /// <returns></returns>
        public TypeQueryBuilder<T> Facet<TField>(Expression<Func<T, IEnumerable<TField>>> fieldSelector, Expression<Func<TField, DateTime>> propertySelector, int? limit = null)
        {
            fieldSelector.ValidateNotNullArgument("fieldSelector");
            propertySelector.ValidateNotNullArgument("propertySelector");
        ...
        /// <param name="limit">Number of facets to be returned</param>
        /// <returns></returns>
        public TypeQueryBuilder<T> Facet<TField>(Expression<Func<T, IEnumerable<TField>>> fieldSelector, Expression<Func<TField, object>> propertySelector, int? limit = null)
        {
            fieldSelector.ValidateNotNullArgument("fieldSelector");
            propertySelector.ValidateNotNullArgument("propertySelector");
