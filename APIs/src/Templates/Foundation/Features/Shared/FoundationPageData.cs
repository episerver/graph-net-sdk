...
namespace Foundation.Features.Shared
{
    ...
    public class FoundationPageData : PageData, ICategorizableContent, IFoundationContent/*, IDashboardItem*/
    {
        #region Page Header
        ...
        #region Content
        [CultureSpecific]
        [Display(Name = "Main intro", GroupName = SystemTabNames.Content, Order = 100)]
