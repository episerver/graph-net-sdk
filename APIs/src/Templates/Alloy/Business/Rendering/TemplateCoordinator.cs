using AlloyMvcTemplates.Models.HeadlessContent;
...
namespace AlloyTemplates.Business.Rendering
{
    ...
    public class TemplateCoordinator : IViewTemplateModelRegistrator
    {
        ...
        public static void OnTemplateResolved(object sender, TemplateResolverEventArgs args)
        {
            ...
            //Disable PreviewController for headless content (has no renderer)
            if (args.ItemToRender is IHeadlessContent && args.SelectedTemplate != null && args.SelectedTemplate.TemplateType == typeof(PreviewController))
            {
                args.SelectedTemplate = null;
            }
        }
