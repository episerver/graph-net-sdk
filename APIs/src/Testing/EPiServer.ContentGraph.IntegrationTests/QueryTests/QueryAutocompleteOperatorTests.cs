...
namespace EPiServer.ContentGraph.IntegrationTests.QueryTests
{
    ...
    public class QueryAutocompleteOperatorTests : IntegrationFixture
    {
        ...
        public static async Task ClassInitialize(TestContext testContext)
        {
            ...
            await SetupData<HomePage>(item1 + item2 + item3 + item4, "t9");
        }
		[TestMethod]
        public async Task autocomplete_id_contains_myid_should_result_3_phrases()
        {
        ...
        [TestMethod]
        public async Task autocomplete_id_contains_myid_and_limit_1_should_result_1_phrase()
        {
            IQuery query = new GraphQueryBuilder(_configOptions, _httpClientFactory)
                .ForType<HomePage>()
                    .Autocomplete(x => x.Id, 
        ...
        [TestMethod]
        public async Task autocomplete_has_value_more_than_10_characters_will_be_ignore()
        {
