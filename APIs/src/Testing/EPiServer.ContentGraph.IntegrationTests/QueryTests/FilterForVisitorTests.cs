...
namespace EPiServer.ContentGraph.IntegrationTests.QueryTests
{
    ...
    public class FilterForVisitorTests : IntegrationFixture
    {
        ...
        public static async Task ClassInitialize(TestContext testContext)
        {
            ...
            await SetupData<Content>(item1 + item2 + item3, "t4");
        }
        [TestMethod]
        public async Task search_without_filter_for_visitors_should_result_3_items()
        {
        ...
        [TestMethod]
        public async Task search_with_filter_for_visitors_should_result_1_item()
        {
