...
namespace EPiServer.ContentGraph.IntegrationTests.QueryTests
{
    ...
    public class LimitTests : IntegrationFixture
    {
        ...
        public static async Task ClassInitialize(TestContext testContext)
        {
            ...
            await SetupData<HomePage>(item1 + item2 + item3 + item4, "t6");
        }
        [TestMethod]
        public async Task search_with_limit_1_should_return_1_hit()
        {
        ...
        [TestMethod]
        public async Task search_with_limit_100_should_return_all_hits()
        {
            var result = await new GraphQueryBuilder(_configOptions, _httpClientFactory)
                .ForType<HomePage>()
                .Fields(x => x.Name, x => x.MainBody)
        ...
        [TestMethod]
        public async Task search_with_limit_101_should_produce_errors()
        {
            ...
            result = await query.GetResultAsync<HomePage>();
